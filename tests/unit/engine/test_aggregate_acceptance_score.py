...
class TestNonFiniteScoreValidation:
    ...
    def test_non_finite_raises_with_reason(
        self, _make_engine, label: str, scores: list[float]
    ) -> None:
    ...
    def test_non_finite_preserves_scores_attr(self, _make_engine) -> None:
