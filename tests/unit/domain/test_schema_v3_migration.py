"""Version 2 results load at schema version 3 with unknown token usage.
...
class TestVersionTwoFixtures:
    """The version 2 fixtures migrate to version 3 without losing fields."""

    def test_evolution_result_v2_loads_with_unknown_usage(self) -> None:
        """The single-agent v2 fixture loads with None usage and its counts kept."""
    ...
    def test_v1_fixture_reaches_version_3(self) -> None:
        """A version 1 dict goes through both migrations."""
